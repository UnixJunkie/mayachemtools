...
def ProcessOptions():
    ...
    if OptionsInfo["EnergyRMSDCutoff"] > 0:
        ...
        if not OptionsInfo["ConfGenerationParams"]["AlignConformers"]:
            MiscUtil.PrintError("The value for \"alignConformers\" specified using \"--confParams\" must  be set to \" yes\" for non-zero values of \"--energyRMSDCutoff\" ")
...
Examples:
    ...
    combination of ETKDG distance geometry methodology, applying embed RMSD
