...
def ValidateOptions():
    ...
    if not re.match("^none$", Options["--energyRMSDCutoff"], re.I):
        ...
        if not re.match("^yes$", Options["--alignConformers"], re.I):
            MiscUtil.PrintError("\"%s\" value of \"--alignConformers\" is not allowed for %s value of \"--energyRMSDCutoff\" option. It must be set to \"yes\"." % (Options["--alignConformers"], Options["--energyRMSDCutoff"]))
