...
def SetupPyMOLObjectNamesForChain(FileIndex, PyMOLObjectNames, ChainID):
    ...
    for GroupType in ["Surface_Residues", "Buried_Residues"]:
        ...
        SetupPyMOLObjectNamesForChainResiduesSurfaces(FileIndex, PyMOLObjectNames, ChainID, ResiduesGroupName, ResiduesGroupID, ResiduesGroupMembersID)
...
def SetupPyMOLObjectNamesForChainResiduesSurfaces(FileIndex, PyMOLObjectNames, ChainID, MainGroupName, MainGroupID, MainGroupMembersID):
