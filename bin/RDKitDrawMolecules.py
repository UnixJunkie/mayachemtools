...
def GenerateImageFile(ValidMols, MolNames, AtomLists, BondLists):
    ...
    try:
        ...
        MolsImage = Draw.MolsToGridImage(ValidMols, molsPerRow = NumOfMolsPerRow,  subImgSize = (Width,Height), legends = MolNames, highlightAtomLists = AtomLists, highlightBondLists = BondLists, useSVG = False, returnPNG = False)
